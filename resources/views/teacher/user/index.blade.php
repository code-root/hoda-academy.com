                                    ...
                                    <form action="{{ route('user2.update', $user_id) }}" method="post"
                                        ...
                                        <div class="row mb-3 g-3">
                                            ...
                                            <div>
                                                ...
                                                <textarea id="textarea" class=" form-control" name="overview_ar" placeholder="اكتب هنا ">{{ $user->overview_ar }}</textarea>
                                            ...
                                            <div>
                                                ...
                                                <textarea id="textarea" class=" form-control" name="overview_en" placeholder="اكتب هنا ">{{ $user->overview_en }}</textarea>
