                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-4">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('customer.show') ? 'active' : '' }}"
                                href="{{ route('teacher.show', $customer->id) }}">
                                <i class="bx bx-user me-1"></i>{{ __('admin.Overview') }}
                            </a>
                        </li> --}}
                        <li class="nav-item">
                            <a class="nav-link {{ Request::route()->getName() == 'teacher.show2' ? 'active ' : '' }} "
                                href="{{ route('teacher.show2', $customer->id) }}">
                ...
                <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                    <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                            ...
                            <form class="row g-3" action="{{ route('teacher.update', $customer->id) }}" method="post"
