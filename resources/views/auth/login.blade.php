...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('images') }}/{{ Setting::find(1)->photo != null ? Setting::find(1)->photo : 'no-image.png' }}" />
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
                    ...
                    <img style="width: 35%;height:auto; " src="{{ asset('images') }}/{{ Setting::find(1)->photo != null ? Setting::find(1)->photo : 'no-image.png' }}"
                    alt="logo">
          ...
          <form method="POST" action="{{ route('login') }}">
            @csrf
              ...
              <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" required autocomplete="email" name="email" placeholder="{{ __('admin.Email') }}" autofocus>
              @error('email')
