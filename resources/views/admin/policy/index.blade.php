        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{!! __('admin.Privacy Policy') !!}</h5>
            ...
            $(document).ready(function() {
                ...
                $('#products-table').DataTable({
                    ...
                    buttons: [{
                        ...
                        {
                            text: '<i class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add Privacy Policy') !!}',
                            ...
                            action: function() {
                                window.location.href = "{{ route('policy.create') }}"
                            }
                        }
                    ],
                    responsive: {
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('policy.destroy', 0) }}">
                                @method('delete')
                                @csrf
