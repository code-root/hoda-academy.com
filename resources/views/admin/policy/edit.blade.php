                                 ...
                                 <div class="card-body">
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $policy->title_ar }}" placeholder="Product title" name="title_ar"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $policy->title_en }}" placeholder="Product title" name="title_en"
                                             aria-label="Product title">
                                     ...
                                     <div>
                                         ...
                                         <textarea  class=" form-control" name="description_ar" placeholder="اكتب هنا ">{{ $policy->description_ar }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <textarea  class=" form-control" name="description_en" placeholder="اكتب هنا ">{{ $policy->description_en }}</textarea>
