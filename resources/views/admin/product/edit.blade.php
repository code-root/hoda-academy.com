                         ...
                         <div class="col-12 col-lg-12">
                             ...
                             <div class="card mb-12">
                                 <div class="card-header">
                                     <h5 class="card-tile mb-0">{!! __('admin.Edit Product') !!}</h5>
                                 </div>
                                 <div class="card-body">
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $product->title_ar }}" placeholder="{!! __('admin.Title_ar1') !!}"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $product->title_en }}" placeholder="{!! __('admin.Title_en1') !!}"
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="overview_ar" placeholder="اكتب هنا ">{{ $product->overview_ar }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="overview_en" placeholder="اكتب هنا ">{{ $product->overview_en }}</textarea>
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="number" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $product->quantity }}" placeholder="{!! __('admin.Quantity') !!}"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <div class="input-group">
                                             <span class="input-group-text">EGP</span>
                                             <input type="number" class="form-control" value="{{ $product->tax }}"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <div class="input-group">
                                             ...
                                             <input type="number" class="form-control" value="{{ $product->price1 }}"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <div class="input-group">
                                             <span class="input-group-text">$</span>
                                             <input type="number" class="form-control" value="{{ $product->tax1 }}"
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="description_ar" placeholder="اكتب هنا ">{{ $product->description_ar }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="description_en" placeholder="اكتب هنا ">{{ $product->description_en }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <input type="file" multiple name="photo" onchange="readURL(this);"
                                             value="{{ $product->photo }}" class="file form-control">
                                         ...
                                         <div class="row last">
                                             <div class="col-md-3 mb-3 position-relative" data-index="0">
                                                 <a target="_blank" href="{{ asset('images') }}/{{ $product->photo }}">
