                                        ...
                                        <div class="row mb-3 g-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" required
                                                    id="ecommerce-product-name" value="{{ $policy->title_ar }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" required
                                                    id="ecommerce-product-name" value="{{ $policy->title_en }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control" required
                                                    id="ecommerce-policy-name" value="{{ $policy->video }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="file" multiple name="photo" onchange="readURL(this);"
                                                    value="{{ $policy->photo }}" class="file form-control">
                                                ...
                                                <div class="row last">
                                                    <div class="col-md-3 mb-3 position-relative" data-index="0">
                                                        <a target="_blank"
                                                            href="{{ asset('images') }}/{{ $policy->photo }}">
                                                            <img id="blah"
                                                                style="width: 100%;height: 100%;padding: 5px;"
                                                                src="{{ asset('images') }}/{{ $policy->photo }}"
                                                                alt="your image" /></a>
                                                    </div>
