                        ...
                        <div class="card-body row widget-separator">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center gap-3 w-100">
                                    ...
                                    <small class="w-px-20 text-end">{{ $count5->firstWhere('rate', 4)->total ?? 0 }}</small>
                                </div>
                                <div class="d-flex align-items-center gap-3 w-100">
                                    ...
                                    <small class="w-px-20 text-end">{{ $count5->firstWhere('rate', 3)->total ?? 0 }}</small>
                                </div>
                                <div class="d-flex align-items-center gap-3 w-100">
                                    ...
                                    <small class="w-px-20 text-end">{{ $count5->firstWhere('rate', 2)->total ?? 0 }}</small>
                                </div>
                                <div class="d-flex align-items-center gap-3 w-100">
                                    ...
                                    <small class="w-px-20 text-end">{{ $count5->firstWhere('rate', 1)->total ?? 0 }}</small>
                                </div>
