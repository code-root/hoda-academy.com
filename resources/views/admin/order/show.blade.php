                                ...
                                <div class="order-calculations">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="text-heading"> @php
                                            ...
                                            $country = $order->country ?? 'Unknown'; // رمز الدولة (EG لمصر)
                                            if ($country == 'Egypt') {
                                                echo 'EGP ' . $order->subtotal ?? 0;
                                            } else {
                                                echo "$" . $order->subtotal ?? 0;
                                            }
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            $('#products-table').DataTable({
                                ...
                                ajax: "{{ route('order.getorder', $order->id) }}",
                                columns: [{
                                            data: " "
                                        },
                                    ...
                                    , {
                                        ...
                                        render: function(t, e, s, a) {
                                            ...
                                            @php
                                                ...
                                                if ($country == 'Egypt') {
                                                    echo 'var price = "EGP "+ ' . 's.price';
                                                } else {
                                                    echo 'var price = "$"+' . 's.price';
                                                }
